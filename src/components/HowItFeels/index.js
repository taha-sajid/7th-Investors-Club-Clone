      ...
      <div className="cards">
        ...
        <div className="card">
          ...
          <div className="data">
            ...
            <div className="description">
              Zero-cost valuation, transfer, inspection, and escrow are included
              with every deal.
            </div>
          </div>
        </div>
        <div className="card">
          ...
          <div className="data">
            ...
            <div className="description">
              ...
              it's sold before making their final decision. We verify everything
              and provide deal closure within 7 days or less.
            </div>
          </div>
        </div>
      </div>
