    ...
    <div className="how-it-works-container">
      ...
      <div className="working-steps-container">
        ...
        <div className="step-numb step-2">
          ...
          <p className="description">
            We'll review your site to determine if it's a good fit. You'll hear
        ...
        <div className="step-numb step-3">
          ...
          <p className="description">
            If it's a good fit, we'll send you a link to the detailed form where
            you'll describe different aspects of your business (traffic,
