  ...
  return (
    <div className="premium-services-container">
      <div className="premium-services-heading">
        <h1>
          <strong> Want investing to be totally hands-free?</strong>
          Premium services: For those who <i> just </i> want to count their
          cash.
        </h1>
        <p className="note">
      ...
      <div className="premium-services-card-container">
        <div className="premium-services-card">
          ...
          <div className="card-note-strong">
            <strong>
              We’ll privately source opportunities for your eyes only and act as
              your buying manager
            </strong>
          </div>
